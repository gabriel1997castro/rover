...
{
    const double R = 0.0605; //Radius of wheels
    Gvel.left_wheels = R*vel.left_wheels;
    Gvel.right_wheels = R*vel.right_wheels;
}

int main(int argc, char **argv)
{   
    const double D = 0.28; //Distance between the wheels
    ...
    while (n.ok())
    {
        ...
        vx = Vs*cos(th);
        vy = Vs*sin(th);
        vth = (Gvel.right_wheels - Gvel.left_wheels)/D;
